...
'Radius Mode' in Particle Designer uses a fixed emit rate of 30 Hz. Since that can't be guaranteed in cocos2d, Cocos2d-x uses a another approach, but the results are almost identical.
