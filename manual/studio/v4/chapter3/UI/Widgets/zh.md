...
&emsp;&emsp;可以通过一张从0到9的PNG图片实现艺术数字的效果，每个数字的高为图片的高，宽为图片的1/10，通过艺术数字可以实现艺术化效果的数字，能够简单有效的丰富游戏的视觉效果。 和FNT字体相比，艺术数字具有以下特性：

&emsp;&emsp;.	制作方便，FNT字体制作复杂，而艺术数字较简单

&emsp;&emsp;.	可用资源少，艺术数字仅支持0-9的数字
...
&emsp;&emsp;制作艺术数字时需要游戏美术设计人员提供一张包含了“0”到“9”的图片，确保顺序为0-9且按照图片宽度进行10等分能够分割出各个独立的数字。
