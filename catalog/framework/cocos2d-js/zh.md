...
- [搭建Cocos2d-JS v3.x 开发环境](../../../manual/framework/cocos2d-js/3-jumping-into-cocos2d-js/3-1-installation/zh.md)
- [创建第一个场景](../../../manual/framework/cocos2d-js/3-jumping-into-cocos2d-js/3-2-creating-your-first-scene/zh.md)
- [添加内容到场景](../../../manual/framework/cocos2d-js/3-jumping-into-cocos2d-js/3-3-adding-content-to-the-scene/zh.md)
- [使用动作让场景活起来](../../../manual/framework/cocos2d-js/3-jumping-into-cocos2d-js/3-4-using-actions-to-animate-scenes/zh.md)
- [场景转换](../../../manual/framework/cocos2d-js/3-jumping-into-cocos2d-js/3-5-transition-between-scenes/zh.md)
- [使用事件管理器创建用户交互](../../../manual/framework/cocos2d-js/3-jumping-into-cocos2d-js/3-6-creating-user-interaction-with-event-manager/zh.md)
...
- [Bake Layer](../../../manual/framework/html5/v3/bake-layer/zh.md)
...
- [如何使用Eclipse中编译Cocos2d-JS项目](../../../manual/framework/html5/jsb/compilation-in-eclipse/zh.md)
...
- [Facebook API Reference for Cocos2d-JS](../../../manual/framework/html5/facebook-sdk/api-reference/zh.md)
- [Android平台上如何集成Facebook平台支持](../../../manual/framework/html5/facebook-sdk/facebook-sdk-on-android/zh.md)
- [iOS平台上如何集成Facebook平台支持](../../../manual/framework/html5/facebook-sdk/facebook-sdk-on-ios/zh.md)
- [Web平台上如何集成Facebook平台支持](../../../manual/framework/html5/facebook-sdk/facebook-sdk-on-web/zh.md)
